...
function Daily_reward() {
  const { dailyrewardarraystate, setDailyRewardArrayState } =
    useDailyRewardHook();
  console.log(dailyrewardarraystate);
  ...
  return (
    <>
      <div className="h-[88vh] w-full bg-[#0c0c1d] fixed overflow-hidden overflow-y-auto">
  ...
  rgba(233, 168, 48, 0.3) 0px 0px 30px 10px`,
          ...
          <div>
            <div className="flex flex-col gap-5">
              {dailyrewardarraystate.map((elem) => {
                return (
                  <div className="w-[96%] mx-auto flex flex-col gap-5 items-start">
        ...
        {showcheckcard &&
          (selectedCardId === "dr" ? (
              ...
              <div className="flex flex-col gap-4 items-center w-[100%] h-[100%] justify-center">
                <div className="grid grid-cols-4 gap-2">
                  {selectedCardReward.map((element) => {
                    return (
                      <div className="w-[22vw] py-2 flex flex-col justify-center items-center gap-1 bg-[#171725] rounded-lg">
            ...
            <div className="fixed pb-10 bottom-0 left-0 w-full h-[60%] text-[#fff] bg-[#171725] border-t-[6px] rounded-t-3xl border-[#e9a830]">
              <div>
                <ImCross
                  className="text-[#fff] text-[22px] bg-slate-500 p-1 rounded-full absolute top-3 right-3"
                  onClick={() => setShowCheckCard(false)}
              ...
              <div className="flex flex-col gap-2 items-center h-[100%] justify-center">
                ...
                <div className="py-4 w-[95%] text-center rounded-2xl bg-[#0861F2]">
